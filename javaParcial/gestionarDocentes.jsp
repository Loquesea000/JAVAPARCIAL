                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${anteproyecto.est == 0}">
                                                    <span class="estado-finalizado"><i class="fas fa-check-circle"></i> Aprobado y Finalizado</span>
                                                </c:when>
                                                <c:when test="${anteproyecto.est == 1 || anteproyecto.est == 3}">
                                                    <span class="estado-activo"><i class="fas fa-play-circle"></i> Revisión</span>
                                                </c:when>
                                                <c:when test="${anteproyecto.est == 2}">
                                                    <span class="estado-revision"><i class="fas fa-sync-alt"></i> Rechazado</span>
                                                </c:when>
                                    <c:otherwise>
