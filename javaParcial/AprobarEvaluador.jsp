...
<div class="container mt-5">
    <h1 class="text-center">Aprobar Anteproyecto</h1>

    <c:if test="${not empty param.idAnteproyecto}">
        <sql:update dataSource="${DataSource}">
            UPDATE anteproyectos
            SET est = 0, calificacion_evaluador = ?
    ...
    <a href="menuEvaluador.jsp?cedulaEstudiante=${sessionScope.cedulaEstudiante}" class="btn btn-primary mt-3">Volver al Menú</a>
</div>
